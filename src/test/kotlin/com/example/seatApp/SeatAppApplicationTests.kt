...
//        assertThat(seats1[0].name, equalTo(1))
        assertThat(seats1[0].filled, equalTo(true))
        assertThat(seats1[0].x, equalTo(440))
        assertThat(seats1[0].y, equalTo(80))
        assertThat(seats2[0].id, equalTo(1))
//        assertThat(seats2[0].name, equalTo(4))
        assertThat(seats2[0].filled, equalTo(true))
        assertThat(seats2[0].x, equalTo(440))
        assertThat(seats2[0].y, equalTo(80))
    }
